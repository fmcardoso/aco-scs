...
class Ant:
    ...
    def can_move(self):
        ...
        # node.
        #  30/11/2014 - F. Cardoso - Modification - Can move only when haven't visited all nodes.
        return len(self.visited) != len(self.world.nodes)
    ...
    def make_move(self, dest):
        ...
        if dest is None:
            ## 30/11/2014 - F. Cardoso - Modification for Hamiltonian path problem.
            ## Don't return to the first node
            return None
        else:
